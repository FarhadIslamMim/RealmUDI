package com.oshnisoft.realmudi;
...
public class UpdateCourseActivity extends AppCompatActivity {
    ...
    private EditText courseNameEdt, courseDurationEdt, courseDescriptionEdt, courseTracksEdt,courseMoneyEdit;

    // creating a strings for storing
    // our values from edittext fields.
    private String courseName, courseDuration, courseDescription, courseTracks,courseMoney;
    private long id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseMoneyEdit = findViewById(R.id.idEdtCourseMoney);
        ...
        courseMoney = getIntent().getStringExtra("courseMoney");
        ...
        courseMoneyEdit.setText(courseMoney);
        ...
        updateCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String courseMoney = courseMoneyEdit.getText().toString();
                ...
                if (TextUtils.isEmpty(courseName)) {
                ...
                } else if (TextUtils.isEmpty(courseMoney)) {
                    courseMoneyEdit.setError("Please enter Course Money");
                } else {
                    ...
                    updateCourse(modal, courseName, courseDescription, courseDuration, courseTracks,courseMoney);
                }
    ...
    private void updateCourse(DataModal modal, String courseName, String courseDescription, String courseDuration, String courseTracks,String courseMoney) {
        ...
        realm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                ...
                modal.setCourseMoney(courseMoney);
