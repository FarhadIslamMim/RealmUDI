...
public class CourseRVAdapter extends RecyclerView.Adapter<CourseRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseRVAdapter.ViewHolder holder, int position) {
        ...
        holder.courseMoneyTV.setText(modal.getCourseMoney());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("courseMoney", modal.getCourseMoney());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView courseNameTV, courseDescTV, courseDurationTV, courseTracksTV,courseMoneyTV;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            courseMoneyTV = itemView.findViewById(R.id.idTVCourseMoney);
        }
    }
}
